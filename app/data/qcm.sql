...
--
ALTER TABLE `question`
  ADD CONSTRAINT `fk_question_typeq` FOREIGN KEY (`idTypeq`) REFERENCES `typeq` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
