...
CREATE TABLE `exam` (`id` int(11) NOT NULL,`dated` datetime DEFAULT CURRENT_TIMESTAMP,`datef` datetime DEFAULT CURRENT_TIMESTAMP,`status` varchar(42) DEFAULT NULL,`idGroup` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `qcm` (`id` int(11) NOT NULL,`name` varchar(42) DEFAULT NULL,`description` varchar(42) DEFAULT NULL,`cdate` datetime DEFAULT CURRENT_TIMESTAMP,`status` varchar(10) DEFAULT NULL,`idExam` int(11) NOT NULL,`idUser` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `qcm` ADD  KEY (`idExam`);
...
ALTER TABLE `qcm` ADD CONSTRAINT `fk_qcm_exam` FOREIGN KEY (`idExam`) REFERENCES `exam` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
