...
return array(
  ...
  'Group' => 'models\\Group',
  'GroupDAOLoader' => 'services\\GroupDAOLoader',
  'User' => 'models\\User',
  ...
  'controllers\\GroupController::addGroup' => array(
    array('#name' => 'get', '#type' => 'Ubiquity\\annotations\\router\\GetAnnotation', "add","name"=>"groupAdd")
  ),
  ...
  'controllers\\GroupController::joinGroup' => array(
    array('#name' => 'get', '#type' => 'Ubiquity\\annotations\\router\\GetAnnotation', "join","name"=>"groupJoin")
  ),
